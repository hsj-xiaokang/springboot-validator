...
public class ValidateControllerV3 {
    ...
    public LeeJSONResult valV3_RequestParam(
	   ...
	   @RequestMapping(value = "/valV3_RequestParam_age",method={RequestMethod.POST,RequestMethod.GET} )
	    public LeeJSONResult valV3_RequestParam_age(
	    				@Max(value=20, message="最大年龄20")   
	                    @RequestParam("age") int age) {
		        LOGGER.info("valV3_RequestParam_age info {}",age);
		        return LeeJSONResult.okWithObject(age,LeeJSONResult.RESCODE_OK);
	    }
}